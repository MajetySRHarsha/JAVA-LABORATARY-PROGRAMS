...
public class LabProgram16 extends Frame  
{  
...
///////////////////////////  
LabProgram16(String frameText)//constructor  
{  
super(frameText);  
...
{  
new LabProgram16("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, LabProgram16 clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, LabProgram16 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(LabProgram16.getFormattedText(tempd));}  
...
cl.displayLabel.setText(LabProgram16.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, LabProgram16 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(LabProgram16.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, LabProgram16 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
